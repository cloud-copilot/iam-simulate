...
const keysByName = globalConditionKeys.reduce(
  (acc, key) => {
...
const variableKeysByName = globalConditionKeys.reduce(
  (acc, key) => {
    if (key.key.includes('/')) {
...
const keysByCategory = globalConditionKeys.reduce(
  (acc, key) => {
...
export function getGlobalConditionKeyWithOrWithoutPrefix(
  key: string
): GlobalConditionKey | undefined {
 ...
 */
export function getVariableGlobalConditionKeyByPrefix(
  prefix: string
): GlobalConditionKey | undefined {
