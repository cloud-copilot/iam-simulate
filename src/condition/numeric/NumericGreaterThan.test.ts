...
import { NumericGreaterThan } from "./NumericGreaterThan.js";

const numericGreaterThanTests: BaseOperatorTest[] = [
  {
...
testOperator('NumericGreaterThan', numericGreaterThanTests, NumericGreaterThan)